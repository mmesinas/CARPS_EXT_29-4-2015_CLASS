...
z_vid <- (int_tra$mean_int_tra[1] - mean(intellect, na.rm = TRUE))/sd(intellect,na.rm = TRUE)
...
c(z_aud, z_tra, z_video)

#z-scores for audio, transcript, and video conditions for 
```
